...
This project implemented the Data Modelling wih Postgres and build an ETL Pipeline using python. Data is extracted from the JSON File format , transformed into a two dimensional datastructure using python pandas dataframe and then ,loaded into the fact and dimension tables in the star schema format, 
...
Project Summary: Data Modeling with Postgres
Introduction
